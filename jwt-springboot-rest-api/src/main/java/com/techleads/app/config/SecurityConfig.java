...
import com.techleads.app.filters.SecurityFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable()
				...
				.authorizeRequests().antMatchers("/users", "/users/token", "/h2-console/**").permitAll()
				.anyRequest()
		...
		//http.csrf().ignoringAntMatchers("/users", "/users/token", "/h2-console/**","/users/welcome");
